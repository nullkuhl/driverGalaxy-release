...
{
    /// <summary>
    /// Interaction logic for PanelPreferences2.xaml
    /// </summary>
    public partial class PanelPreferences2
    {
        ...
        private void ShowPanelLicense(object sender, RoutedEventArgs e)
        {
            ((MainWindow)Application.Current.MainWindow).ShowPanelLicense(null, null);
        }
